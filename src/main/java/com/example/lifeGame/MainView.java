...
public class MainView extends VBox {
    ...
    public MainView(Controller c) {
        ...
        ap.getChildren().addAll(this.buttonStart,this.textField,this.buttonStep,this.buttonStop,this.buttonClear,this.buttonRandom);
        ...
        this.buttonStart.setOnAction(actionEvent -> c.start(actionEvent, textField));
        this.buttonStep.setOnAction(actionEvent -> c.step());
        this.buttonStop.setOnAction(actionEvent -> c.stop());
        this.buttonClear.setOnAction(actionEvent -> LifeGame.START = 3);
        this.buttonRandom.setOnAction(actionEvent -> c.random(this));
    ...
    private void dragScreen(MouseEvent mouseEvent) {
        if(mouseEvent.getButton().equals(MouseButton.PRIMARY)) {
            ...
            if( Math.floor(fOffsetX/SIZEX) == Math.floor(fStartPanX/SIZEX))
    ...
    public void draw() {
        ...
        for (Coords c : LifeGame.gameZone.keySet()) {
            ...
            drawPoint(g, c,LifeGame.gameZone.get(c));
        }
